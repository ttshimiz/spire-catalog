\begin{deluxetable}{lllcclcc}\label{tbl:bat_info}
...
\enddata
\tablecomments{\textit{Column 1:} Name of the source. \textit{Column 2:} Right ascension in J2000 coordinates. \textit{Column 3:} Declination in J2000 coordinates. \textit{Column 4:} Redshift of the source. \textit{Column 5:} Luminosity distance of the source in Mpc. \textit{Column 6:} AGN type from the \swift/BAT 70 month catalog. \textit{Column 7:} \herschel{} Operational Day number for when the observation started. \textit{Column 7:} \herschel{} Observation Identification number. The full table is available in the online version}
\end{deluxetable} 
